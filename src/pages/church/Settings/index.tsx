...
export default function Settings() {
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.title}>{t("churchPages.settings.myProfile")}</Text>
      ...
      <View style={styles.cardContainer}>
        <View style={styles.content}>
          <View style={styles.leftContent}>
            ...
            <View>
              <Text style={styles.titleProfile}>{t(`churchPages.settings.accountType.${user?.level}`)}</Text>
        ...
        <TouchableOpacity onPress={onOpen} style={styles.button}>
          <Text style={styles.buttonText}>{t("churchPages.settings.changeAccount")}</Text>
        </TouchableOpacity>
      </View>
      ...
      <Text style={styles.title}>{t("churchPages.settings.settings")}</Text>
      <ScrollView>
        <ArrowListItem icon="question-circle" title={t("churchPages.settings.help")} subtitle={t("churchPages.settings.helpSubtitle")} />
        <ArrowListItem icon="shield-alt" title={t("churchPages.settings.terms")} subtitle={t("churchPages.settings.termsSubtitle")} />
        ...
        <ArrowListItem icon="sign-out-alt" title={t("churchPages.settings.signOut")} onPress={signOut} />
      </ScrollView>
    </View>
  );
}
